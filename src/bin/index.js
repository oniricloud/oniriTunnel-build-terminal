...
// const { versions } = Pear
console.log('Oniri Service running')
                ...
                if (statusResData.error) {
                    ...
                    if (statusResData.data.configured) {
                        if (statusResData.data.services.remotes.length > 0) {
                            ...
                            console.log(table(
                                ["name", "port", "host"],
                                statusResData.data.services.remotes.map(remote => [remote.name, remote.proxyPort, remote.proxyHost]),
                        ...
                        if (statusResData.data.services.local.length > 0) {
                            ...
                            console.log(table(
                                ["name", "port", "host" ],
                                statusResData.data.services.local.map(local => [local.name, local.targetPort, local.targetHost]),
                                { width: 100, align: ['left', 'left', 'center'] }
                            ));
                            console.log("\n", `Allowed Store:`, "\n");
                            console.log(table(
